...
import (
	...
	"github.com/QuantumNous/token-continent/relay/channel/ai360"
	"github.com/QuantumNous/token-continent/relay/channel/lingyiwanwu"

	//"github.com/QuantumNous/token-continent/relay/channel/minimax"
	"github.com/QuantumNous/token-continent/relay/channel/openrouter"
	"github.com/QuantumNous/token-continent/relay/channel/xinference"
	relaycommon "github.com/QuantumNous/token-continent/relay/common"
	"github.com/QuantumNous/token-continent/relay/common_handler"
	...
	"github.com/QuantumNous/token-continent/setting/reasoning"
...
func (a *Adaptor) SetupRequestHeader(c *gin.Context, header *http.Header, info *relaycommon.RelayInfo) error {
	...
	if info.ChannelType == constant.ChannelTypeOpenRouter {
		...
		if header.Get("X-OpenRouter-Title") == "" {
			header.Set("X-OpenRouter-Title", "Token Continent")
		}
	}
	return nil
}
