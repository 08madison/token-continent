...
import (
	...
	"github.com/QuantumNous/token-continent/pkg/cachex"
...
const (
	...
	channelAffinityCacheNamespace           = "token-continent:channel_affinity:v1"
	channelAffinityUsageCacheStatsNamespace = "token-continent:channel_affinity_usage_cache_stats:v1"
)
